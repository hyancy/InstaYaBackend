...
const ordenesSchema = mongoose.Schema({
  ...
  ancho_paquete: { type: Number, required: [true, 'Ingrese dimesiones del paquete'], label: 'ancho' },
  alto_paquete: { type: Number, required: [true, 'Ingrese dimesiones del paquete'], label: 'alto' },
  largo_paquete: { type: Number, required: [true, 'Ingrese dimesiones del paquete'], label: 'largo' },
  ...
  estado_pedido: { type: String, enum: ['Guardado', 'Cancelado', 'Cumplido'], required: true, default: 'Guardado' },
},
  {
    timestamps: true,
    versionKey: false,
